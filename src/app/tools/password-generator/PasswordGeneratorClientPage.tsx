...
export default function PasswordGeneratorClientPage() {
  ...
  const getPasswordStrength = (pwd: string) => {
    ...
    if (score < 3) return { strength: "Weak", color: "text-red-500", bgColor: "bg-red-100" }
    if (score < 5) return { strength: "Medium", color: "text-yellow-500", bgColor: "bg-yellow-100" }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-serif font-bold text-foreground mb-2">Password Generator</h1>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox id="exclude" checked={excludeSimilar} onCheckedChange={setExcludeSimilar} />
                    <Label htmlFor="exclude">Exclude Similar Characters (0, O, l, 1, |)</Label>
                  </div>
                </div>
                  ...
                  <>
                    ...
                    {strengthInfo && (
                      <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                        ...
                        <Badge className={`${strengthInfo.color} ${strengthInfo.bgColor}`}>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span>Length:</span>
                        <Badge variant="outline">{password.length} characters</Badge>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span>Entropy:</span>
                        <Badge variant="outline">~{Math.floor(password.length * 3.3)} bits</Badge>
                      </div>
                    </div>
                  </>
                ) : (
          ...
          <Card className="mt-6">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-foreground mb-2">Strong Password Guidelines</h4>
                ...
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    ...
                    <li>• Check for data breaches regularly</li>
                  </ul>
                </div>
              </div>
            </CardContent>

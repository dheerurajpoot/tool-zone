      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-serif font-bold text-foreground mb-2">Base64 Encoder/Decoder</h1>
            ...
            <TabsContent value="encode">
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <Label htmlFor="encode-input">Plain Text Input</Label>
                    <Textarea
                      id="encode-input"
                    ...
                    <div className="flex justify-between items-center mt-2">
                      ...
                      <Button onClick={encodeToBase64} size="sm">
                        Encode
                      </Button>
                    </div>
                  </div>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Button
                          ...
                          className="h-8"
                        >
                          {copied === "encode" ? <Check className="w-4 h-4" /> : <Copy className="w-4 h-4" />}
                        </Button>
                      </div>
                      <Textarea id="encode-output" value={encodeOutput} readOnly rows={6} className="bg-muted/50" />
                      <Badge variant="secondary" className="text-xs mt-2">
                        Base64 Length: {encodeOutput.length}
                      </Badge>
                    </div>
                  )}
                </CardContent>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <div className="flex justify-between items-center mt-2">
                      ...
                      <Button onClick={decodeFromBase64} size="sm">
                        Decode
                      </Button>
                    </div>
                  </div>
                  ...
                  {decodeOutput && (
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <Label htmlFor="decode-output">Plain Text Output</Label>
                        <Button
                          ...
                          className="h-8"
                        >
                          {copied === "decode" ? <Check className="w-4 h-4" /> : <Copy className="w-4 h-4" />}
                        </Button>
                      </div>
                      <Textarea id="decode-output" value={decodeOutput} readOnly rows={6} className="bg-muted/50" />
                      <Badge variant="secondary" className="text-xs mt-2">
                        Text Length: {decodeOutput.length}
                      </Badge>
                    </div>
                  )}
                </CardContent>
          ...
          <Card className="mt-6">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-foreground mb-2">What is Base64?</h4>
                  <p className="text-sm text-muted-foreground text-pretty leading-relaxed">
                    Base64 is a binary-to-text encoding scheme that represents binary data in an ASCII string format.
                    It's commonly used for encoding data in email, web applications, and data storage.
                  </p>
                </div>
                <div>
